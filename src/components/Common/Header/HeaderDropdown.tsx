    ...
    return (
        <Dropdown className='bg-content2 !p-0 !rounded-none w-64'>
            ...
            <DropdownMenu aria-label="Static Actions" className='!px-0 !rounded-none'>
                <DropdownItem className="rounded-none !px-0" key="profile" textValue='Profile'>
                    <Button className='bg-tranparent px-4 py-14 !pt-16 flex flex-col items-start !w-full border-b !border-neutral-300 rounded-none' size="sm" radius='none' >
                        <User
                            avatarProps={{
                                src: "https://i.pravatar.cc/150?u=a04258114e29026702d",
                            }}
                ...
                <DropdownItem className="rounded-none" key="message" textValue='Message'>
                    <Button className='bg-tranparent text-md font-light' size="sm" radius='none' >
                ...
                <DropdownItem className="rounded-none" key="setting" textValue='Setting'>
                    <Button className='bg-tranparent text-md font-light' size="sm" radius='none' >
                        <IoIosSettings className='w-5 h-5' />
                        Setting
                    </Button>
                </DropdownItem>
                <DropdownItem className="rounded-none" key="language" textValue='Language'>
                    <Button className='bg-tranparent text-md font-light' size="sm" radius='none' >
                        <FaLanguage className='w-5 h-5' />
                        Language
                    </Button>
                </DropdownItem>
                <DropdownItem className="rounded-none" key="logout" textValue='Logout' onPress={handleLogouts}>
                    <Button className='bg-tranparent text-md font-light' size="sm" radius='none' onPress={handleLogouts}>
                        <GoSignOut className='w-5 h-5' />
                        Logout
                    </Button>
                </DropdownItem>
                <DropdownItem className='rounded-none border-t !border-neutral-300' key="footer" textValue='Footer'>
