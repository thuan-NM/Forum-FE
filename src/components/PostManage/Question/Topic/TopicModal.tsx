import { Autocomplete, AutocompleteItem, Button, Form, Input, Modal, ModalBody, ModalContent, ModalHeader, Textarea } from '@heroui/react'
                        ...
                        <>
                            ...
                            <>
                                ...
                                <ModalBody className='px-0 py-0'>
                                    <Autocomplete className="w-full px-6" radius='none' label="Add topic" variant='bordered' size='sm'>
                                        {animals.map((animal) => (
